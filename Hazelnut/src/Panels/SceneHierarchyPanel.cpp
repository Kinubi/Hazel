...
namespace Hazel {
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		DrawComponent<ScriptComponent>("Script", entity, [entity, scene = m_Context](auto& component) mutable
			{
				...
				UI::ScopedStyleColor(ImGuiCol_Text, ImVec4(0.9f, 0.2f, 0.3f, 1.0f), !scriptClassExists);
		...
		DrawComponent<SpriteRendererComponent>("Sprite Renderer", entity, [](auto& component)
			{
				...
				labelSize.x += 20.0f;
				float buttonLabelSize = glm::max<float>(100.f, labelSize.x);
				ImGui::Button(label.c_str(), ImVec2(buttonLabelSize, 0.0f));
		...
		DrawComponent<BoxCollider2DComponent>("Box Collider 2D", entity, [](auto& component)
			{
				...
				ImGui::DragFloat2("Size", glm::value_ptr(component.Size), 0.05f, 0.0f);
		...
		DrawComponent<TextComponent>("Text Renderer", entity, [](auto& component)
			{
				ImGui::InputText("Text String", &component.TextString);
				ImGui::ColorEdit4("Color", glm::value_ptr(component.Color));
