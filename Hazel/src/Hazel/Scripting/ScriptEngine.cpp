...
namespace Hazel {
	...
	namespace Utils {
		...
		{
			ScopedBuffer fileData = FileSystem::ReadFileBytes(assemblyPath);
			...
			if (loadPDB)
			{
				...
				{
					ScopedBuffer pdbFileData = FileSystem::ReadFileBytes(pdbPath);
	...
	bool ScriptEngine::LoadAssembly(const std::filesystem::path& filepath)
	{
		...
		s_Data->AppDomain = mono_domain_create_appdomain((char*)"HazelScriptRuntime", nullptr);
